...
lua "$PROJECT_DIR/wax/lib/build-scripts/luac.lua" "" patch.dat "$SOURCE_SCRIPTS_DIR/" "$SOURCE_SCRIPTS_DIR/init.lua" -L "$SOURCE_SCRIPTS_DIR"/**/*.lua
mv patch.dat "$DESTINATION_SCRIPTS_DIR"
